...
L.BCM_AltInvite = "Makes all player names in chat ALT-clickable, which invites that person to your group."
...
L.CLICKTOCOPY = "Shift-click to copy chat."
